...
private String id;
    ...
    public GUI_Komputer() {
        ...
        komputer aio = new komputer(10, "B002", "Komputer AIO", "");
        this.stok = 10;
        this.id = "B002";
        this.nama = "Komputer AIO";
        this.tgl = "27 March 2025";
        jTextField1.setText((aio.id));
        jTextField3.setText(Integer.toString(aio.stok));
        jTextField2.setText((aio.nama));
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DATA BARANG KOMPUTER");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (selectedDate != null) {
            ...
            tgl = sdf.format(selectedDate);
            komputer aio = new komputer(stok, id, nama, tgl);
            jTextArea1.append("Data Barang\n");
            jTextArea1.append("--------------------------------------------------------\n");
            jTextArea1.append("ID BARANG               : " + aio.Id_Barang +"\n");
            jTextArea1.append("NAMA BARANG        : " + aio.Nama_Barang + "\n");
            jTextArea1.append("STOK BARANG        : " + aio.stok_barang+ "\n");
            jTextArea1.append("TANGGAL MASUK   : " + aio.tanggal_masuk+"\n");
        } else {
