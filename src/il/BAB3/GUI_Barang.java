...
public class GUI_Barang extends javax.swing.JFrame{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        barang ye = new barang(stok, id, nama, tgl);
        jTextArea1.append("Data Barang\n");
        jTextArea1.append("--------------------------------------------------------\n");
        jTextArea1.append("ID BARANG               : " + ye.Id_Barang +"\n");
        jTextArea1.append("NAMA BARANG        : " + ye.Nama_Barang + "\n");
        jTextArea1.append("STOK BARANG        : " + ye.stok_barang+ "\n");
        jTextArea1.append("TANGGAL MASUK   : " + ye.tanggal_masuk+"\n");
    } else {
