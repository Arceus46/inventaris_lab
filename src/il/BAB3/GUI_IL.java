 ...
 * @author Shadow
 */
public class GUI_IL extends javax.swing.JFrame {
    String IDP, IDU, IDB, IDA, TGL_P, TGL_K;  //Atribut
    int charge; //Atribut
    /**
     * Creates new form GUI_IL
     */
    public GUI_IL() {
        initComponents();
        ...
        this.IDP = jTextField2.getText();
        this.charge = Integer.parseInt(jTextField1.getText());
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "P001", "P002", "P003", "P004", "P005" }));
        jComboBox1.setSelectedIndex(0);
        jComboBox1.setSelectedItem("");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A001", "A002", "A003", "A004", "A005" }));

        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "B001", "B002", "B003", "B004", "B005" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_IL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
